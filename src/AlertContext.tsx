import { createContext, useContext, createSignal, JSXElement } from 'solid-js';
...
const AlertContext = createContext<AlertContextValues | undefined>(initialContextValue);
...
export function AlertProvider(props: AlertProviderProps) {
  ...
  return (
    <AlertContext.Provider value={{ alerts: alerts(), addAlert, removeAlert }}>
      {props.children}
