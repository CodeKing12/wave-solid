...
export const VideoJS = ({ options, onReady, quitPlayer }: VideoPlayerProps) => {
							...
							userActions: {
								hotkeys: function (event: KeyboardEvent) {
									...
									if (event.key === "ArrowUp") {
										...
										const timeSinceLastEnter =
											currentTimestamp -
											keyTimestamps.arrowUpTimestamp;
	...
	return (
		<div data-vjs-player>
			{/* <video-js id="video-js" class="vjs-big-play-centered"></video-js> */}
			<div
				ref={ref}
				class={
					focused ? "spatial-is-focused" : "is-not-focused-spatial"
				}
			></div>
		</div>
	);
